...
To read about a play by play of how it was built (including some embarassing mistakes) in 50min checkout [this blog post](https://matthewayne.com/post/people-in-space/).
